...
VulkanInstance::VulkanInstance()
{
  ...
  const auto* const sdlInstanceExtensions = SDL_Vulkan_GetInstanceExtensions(&sdlInstanceExtensionCount);
  ...
  constexpr vk::ApplicationInfo applicationInfo{.sType = vk::StructureType::eApplicationInfo,
